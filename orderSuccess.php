...
$query = $connection->query("SELECT * FROM orders WHERE id=(SELECT MAX(id) FROM orders)");
...
$callback_url = 'localhost/booking-page.php'; //redirect url, the page that will handle the response from pesapal.
