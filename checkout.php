...
$query = $connection->query("SELECT * FROM customers WHERE id=(SELECT MAX(id) FROM customers)");
...
$query = $connection->query("SELECT * FROM customers WHERE id = ".$_SESSION['sessCustomerID']);
...
<br>
    ...
    <div class="footBtn">
        <a href="booking-page.php" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i> Continue Booking</a>
...
<a href="cartAction.php?action=placeOrder" class="btn btn-success orderBtn">Book Hostel(s)<i class="glyphicon glyphicon-menu-right"></i></a>
